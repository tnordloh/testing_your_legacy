...
Also, while these first few tests are very hard to build, doing so provides an opportunity to figure out everything needed to set up many other tests.  The hope is that, going through this process will provide results that can be leveraged throughout your application, and speed up the process of building tests in the future.
